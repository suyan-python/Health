            ...
            <div className="form-area bg-green-400 border-2 ">
                ...
                <form className="content-area" onSubmit={handleSubmit}>
                    <div className="email flex items-center px-4 border border-green-500 py-1 px-4 mx-4 rounded-md w-56">
                        <div><MdEmail /></div>
                        <input className="px-4 w-44 border-none outline-none"
                            type="email"
                            name="email"
                            id="email"
                            label="email"
                    ...
                    <div className="number flex items-center px-4 border border-green-500 py-1 px-4 mx-4 rounded-md w-56">
                        ...
                        <div></div><input className="px-4 w-44 border-none outline-none"
                            type="tel"
                            name="contact"
                            id="contact"
                            label="contact"
                    ...
                    <div className="btn-sign">
                        <button type="submit" className="px-3 py-1  rounded-xl bg-green-200 hover:text-blue-500 hover:scale-105 font-light">
                            Sign Up
                        </button>
                    </div>
